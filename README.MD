...
`auik-ext-plot` is an extension for the [Auik](https://repos.homedatasrv.ru/app3d/auik) library that provides widgets for displaying and editing 2D curves.  
...
- [auik](https://repos.homedatasrv.ru/app3d/auik)
